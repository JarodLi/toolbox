...
#RUN curl https://raw.githubusercontent.com/oh-my-fish/oh-my-fish/master/bin/install | fish 
  && rm -rf /root/.local/share/omf && rm -rf /root/.local/share/fish && rm -rf /root/.config/fish && rm -rf /root/.config/omf \
...
#
  && curl https://raw.githubusercontent.com/oh-my-fish/oh-my-fish/master/bin/install > /root/fish_install \
