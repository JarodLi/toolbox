...
map("i", "<A-1>", "<esc>:BufferLineGoToBuffer 1<CR>", opt)
map("i", "<A-2>", "<esc>:BufferLineGoToBuffer 2<CR>", opt)
map("i", "<A-3>", "<esc>:BufferLineGoToBuffer 3<CR>", opt)
map("i", "<A-4>", "<esc>:BufferLineGoToBuffer 4<CR>", opt)
map("i", "<A-5>", "<esc>:BufferLineGoToBuffer 5<CR>", opt)
map("i", "<A-6>", "<esc>:BufferLineGoToBuffer 6<CR>", opt)
map("i", "<A-7>", "<esc>:BufferLineGoToBuffer 7<CR>", opt)
map("i", "<A-8>", "<esc>:BufferLineGoToBuffer 8<CR>", opt)
map("i", "<A-9>", "<esc>:BufferLineGoToBuffer 9<CR>", opt)
