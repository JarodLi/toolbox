...
map("n", "<leader>bl", ":BufferCloseBuffersRight<CR>", opts)
map("n", "<leader>bh", ":BufferCloseBuffersLeft<CR>", opts)
...
map('n', '<Space>bb', ':BuffbufferlineerOrderByBufferNumber<CR>', opts)
